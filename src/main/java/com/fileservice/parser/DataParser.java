...
public class DataParser {
    ...
    private static List<String> breakEachLine(String line) {
        ...
        return Arrays.asList(StringUtils.split(s3, "/"));
    }
    ...
    public static Triple<String, String, String> getSplitedSale(String sale) {
        ...
        List<String> split = Arrays.asList(StringUtils.split(replace, "/"));
    ...
    public static List<List<String>> getSplitedItems(String items) {
        ...
        List<String> split1 = Arrays.asList(StringUtils.split(items, ","));

        return split1.stream().map(s -> Arrays.asList(StringUtils.split(s, "-"))).collect(Collectors.toList());
    }
 }
