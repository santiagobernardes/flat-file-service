...
public class DataWriterTest {
    ...
    public void shouldCreateOutputContent() {
        ...
        Assert.assertEquals(
                outputData,
                Arrays.asList(amountOfCustomers, amountOfSalesmen, mostExpensiveSale, worstSalesmanEver)
        );
    }

    @Test
    public void shouldCreateOutputContentWithoutOneLine() {
        final String amountOfCustomers = "The TOTAL AMOUNT OF CUSTOMERS inside de input directory is: 2";
        final String amountOfSalesmen = "The TOTAL AMOUNT OF SALESMEN inside de input directory is: 2";
        final String mostExpensiveSale = "THE SYSTEM WASN'T ABLE TO FIND ANY REGISTERED SALE IN THE INPUT DIRECTORY";
        final String worstSalesmanEver = "THE SYSTEM WASN'T ABLE TO FIND ANY REGISTERED SALE IN THE INPUT DIRECTORY";
        ...
        Assert.assertEquals(
                outputData,
                Arrays.asList(amountOfCustomers, amountOfSalesmen, mostExpensiveSale)
        );

        Assert.assertEquals(outputData.size(), 3);
    }
}